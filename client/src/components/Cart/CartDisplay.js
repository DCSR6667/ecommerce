...
const CartDisplay = () => {
  ...
  useEffect(() => {
    fetch(`${backendUrl}/get_cart_items/${login.id}`)
  ...
  const increaseQuantity = ({ id }) => {
    fetch(`${backendUrl}/increment_quantity/`, {
      method: "PATCH",
      headers: {
  ...
  const decreaseQuantity = ({ id, quantity }) => {
    fetch(`${backendUrl}/decrement_quantity/`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const moveToWishList = (prod) => {
    fetch(`${backendUrl}/move_to_wishlist`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteItem = ({ id }) => {
    fetch(`${backendUrl}/delete_cart_item/`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  return (
    <div className="container">
      <div className={"row justify-content-center mt-3 " + css["cart_title"]}>
        <div className="col-2">CART ITEMS</div>
        <div className="col-4">Total Price: ${totalPrice} </div>
      </div>
                ...
                <div className="row">
                  ...
                  <div className="col-6" style={{ marginLeft: "26px" }}>
                    ...
                    <div className={"row mt-2 " + css["quantity"]}>
                      ...
                      <div
                        className={"col-1 ml-1 " + css["minus"]}
                    ...
                    <div className="row mt-3">
                      <div
                        className={"col-6 p-2 rounded " + css["move"]}
                        onClick={() => {
                          moveToWishList(item);
                        }}
